...
my $DEFAULT_CONFIG_FILE = 'swish-cgi.config';
...
sub default_config {
    ...
    return {
        title           => 'Search Purisma Intranet',  # Title of your choice.  Displays on the search page
        ...
        swish_index     => '/home/data/swish/index.swish-e',    # Location of your index file
