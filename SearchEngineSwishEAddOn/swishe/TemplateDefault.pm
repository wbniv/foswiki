...
function launchWindow( theUrl ) {
  win = open( theUrl, "SearchHelp", "titlebar=0,width=500,height=480,resizable,scrollbars");
    if( win ) {
	win.focus();
    }
    return false;
...
<tr><td>
    <form method="get" action="$form" enctype="application/x-www-form-urlencoded" class="form">
        <input maxlength="200" value="$query" size="40" type="text" name="query"/>
        $hidden
        <input value="Search!" type="submit" name="submit"/>
<!-- PURISMA CUSTOMIZED: Add 'help' link to twiki -->
	&nbsp;&nbsp;&nbsp;<a onclick="launchWindow('http://twiki.corp.purisma.com/do/view/TWiki/SwishSearchSyntax?skin=print.pattern'); return false;" href="#Open New Window">Help</a>
<br>

        $advanced_form
    </form>
<!-- PURISMA CUSTOMIZED: add links back to twiki and bugtracking -->
</td><td><img width=80 src="/images/blank.gif"></td>
<td valign="top">
<table><tr><td colspan=2><b>Other Links</b></td></tr>
<tr><td><a href="/do/view/Howto/WebContents">TWiki Howto</a></td>
<td><a href="http://buildbox:8080/qa">QA home</a></td></tr>
<tr><td><a href="/do/view/Dev/WebContents">TWiki Dev</a></td>
<td><a href="http://buildbox:7001/bugzero/jsp/login.jsp">Bugzero</a></td></tr>
<tr><td><a href="/do/view/Prod/WebContents">TWiki Prod</a></td>
<td><a href="http://ntserv1:81/">NtServ1</a></td></tr></table>
</td></tr></table>
EOF
}
