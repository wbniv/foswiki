...
sub initPlugin {
    ...
    # $TWiki::cfg{Plugins}{HttpsRedirectPlugin}{ExampleSetting} = 1;
...
sub DISABLE_completePageHandler {
    ...
    #TODO: Could implement some defensive code to empty the page there in case we got redirected to HTTPS
