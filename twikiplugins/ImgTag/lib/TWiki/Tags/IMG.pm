# Tag for TWiki Enterprise Collaboration Platform, http://TWiki.org/
#
...
This is a pretty winky-dink tag that allows people to use %IMG{"foo.gif"}% instead
...
sub IMG {
    my($twikiObj, $params, $theTopic, $theWeb) = @_;
    # $twikiObj  - a reference to the TWiki session object (if you don't know
