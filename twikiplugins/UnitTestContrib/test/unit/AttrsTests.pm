...
sub test_unquoted {
    ...
    my $attrs =
      TWiki::Attrs->new( "var1=val1 var2= val2, var3 = 3 var4 =val4", 1 );
...
sub test_escapes {
    ...
    my $attrs =
      TWiki::Attrs->new( "var1=\\\"val1 var2= \\\'val2, var3 = 3 var4 =val4",
        1 );
    $this->assert_str_equals( "\"val1", $attrs->remove("var1") );
    $this->assert_str_equals( "\'val2", $attrs->remove("var2") );
    $this->assert_str_equals( "3",      $attrs->remove("var3") );
...
sub test_extractValue2 {
    ...
    my $s = '"abc def="ghi" jkl" def="mno" pqr=" stu="vwx""';
    $this->assert_str_equals( 'ghi', TWiki::Attrs::extractValue( $s, "def" ) );
}
...
sub test_extractValue3 {
    ...
    my $s = '"abc def="ghi" jkl" def="mno" pqr=" stu="vwx""';
    $this->assert_str_equals( '', TWiki::Attrs::extractValue( $s, "jkl" ) );
}
...
sub test_extractValue5 {
    ...
    my $s = '"abc def="ghi" jkl" def="mno" pqr=" stu="vwx""';
    $this->assert_str_equals( 'vwx', TWiki::Attrs::extractValue( $s, 'stu' ) );
}
