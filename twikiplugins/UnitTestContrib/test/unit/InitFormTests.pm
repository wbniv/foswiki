...
sub setup_formtests {
    ...
    my ( $text, $tmpl ) =
      TWiki::UI::Edit::init_edit( $this->{twiki}, 'myedit' );
...
'<input type="text" name="IssueName" value="My first defect" size="73" class="twikiInputField twikiEditFormTextField twikiMandatory" />',
...
Simple description of problem</textarea>', get_formfield( 2, $text )
    ...
    $this->assert_html_matches(
'<select name="IssueType" class="twikiSelect twikiEditFormSelect" size="1"><option class="twikiEditFormOption">Defect</option><option class="twikiEditFormOption">Enhancement</option><option class="twikiEditFormOption">Other</option></select>',
    ...
    $this->assert_html_matches(
        '<input type="text" name="History2" value="' 
          . $aurl
          . '" size="20" class="twikiInputField twikiEditFormTextField" />',
    ...
    $this->assert_html_matches(
'<input type="text" name="History4" value="%ATTACHURL%" size="20" class="twikiInputField twikiEditFormTextField" />',
...
"formtemplate=\"$testweb.$testform\" templatetopic=\"$testweb.$testtmpl\""
    ...
    $this->assert_html_matches(
'<input type="text" name="IssueName" value="_An issue_" size="73" class="twikiInputField twikiEditFormTextField twikiMandatory" />',
        get_formfield( 1, $text )
    );
    $this->assert_html_matches(
'<textarea name="IssueDescription"  rows="5" cols="55" class="twikiInputField twikiEditFormTextAreaField">
---+ Example problem</textarea>', get_formfield( 2, $text )
    ...
    $this->assert_html_matches(
'<select name="IssueType" class="twikiSelect twikiEditFormSelect" size="1"><option class="twikiEditFormOption" selected="selected">Defect</option><option class="twikiEditFormOption">Enhancement</option><option class="twikiEditFormOption">Other</option></select>',
        get_formfield( 3, $text )
    );
    $this->assert_html_matches(
        ...
        get_formfield( 4, $text ) );
    $this->assert_html_matches(
'<input type="text" name="History2" value="%SCRIPTURL%" size="20" class="twikiInputField twikiEditFormTextField" />',
        get_formfield( 5, $text )
    );
    $this->assert_html_matches(
        ...
        get_formfield( 6, $text ) );
    $this->assert_html_matches(
'<input type="text" name="History4" value="%SCRIPTURL%" size="20" class="twikiInputField twikiEditFormTextField" />',
        get_formfield( 7, $text )
    );
...
Simple description of problem</textarea>', get_formfield( 2, $text )
    ...
    $this->assert_html_matches(
'<select name="IssueType" class="twikiSelect twikiEditFormSelect" size="1"><option class="twikiEditFormOption">Defect</option><option class="twikiEditFormOption" selected="selected">Enhancement</option><option class="twikiEditFormOption">Other</option></select>',
        get_formfield( 3, $text )
    );
    $this->assert_html_matches(
        ...
        get_formfield( 4, $text ) );
    $this->assert_html_matches(
'<input type="text" name="History2" value="%ATTACHURL%" size="20" class="twikiInputField twikiEditFormTextField" />',
        get_formfield( 5, $text )
    );
    $this->assert_html_matches(
        '<input type="hidden" name="History3" value="%ATTACHURL%"  />',
