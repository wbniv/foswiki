...
{ package ControlsPluginBuild;

  @ControlsPluginBuild::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "ControlsPlugin", "Build" ), $class );
  }
