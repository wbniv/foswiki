...
{ package TwistyBundleTWiki04x02Build;

  @TwistyBundleTWiki04x02Build::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "TwistyBundleTWiki04x02" ), $class );
  }
...
$build = new TwistyBundleTWiki04x02Build();
