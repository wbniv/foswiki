...
package TWiki::Plugins::TaskExePlugin;
...
$SHORTDESCRIPTION = 'Allows for TaskExeContrib setting configuration.';
...
sub initPlugin {
    ...
    #my $setting = $TWiki::cfg{Plugins}{TaskExePlugin}{ExampleSetting} || 0;
    $debug = $TWiki::cfg{Plugins}{TaskExePlugin}{Debug} || 0;
