...
{ package TwistyBundleTWiki04x01Build;

  @TwistyBundleTWiki04x01Build::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "TwistyBundleTWiki04x01" ), $class );
  }
...
$build = new TwistyBundleTWiki04x01Build();
