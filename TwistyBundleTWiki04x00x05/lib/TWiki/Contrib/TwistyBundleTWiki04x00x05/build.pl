...
{ package TwistyBundleTWiki04x00x05Build;

  @TwistyBundleTWiki04x00x05Build::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "TwistyBundleTWiki04x00x05" ), $class );
  }
...
$build = new TwistyBundleTWiki04x00x05Build();
