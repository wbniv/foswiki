...
{ package AdvertsPluginBuild;

  @AdvertsPluginBuild::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "AdvertsPlugin", "AdvertsPlugin" ), $class );
  }
