...
// Default text encoding to use whDEFAULT_ENCODINGen no encoding information is available
define('DEFAULT_ENCODING', $_CONFIG['DefaultEncoding']);
...
define('GS_PATH',$_CONFIG['GhostscriptPath']);
